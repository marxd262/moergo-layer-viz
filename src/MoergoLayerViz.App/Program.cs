...
class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        // exe with --veloapp-* arguments during install/update/uninstall
        // hooks, and those subprocesses would otherwise be blocked by the
        // mutex held by the primary running instance.
